...
@RestController
@RequestMapping("/api/web-socket-kafka-vanila-jh-kafka")
public class WebSocketKafkaVanilaJhKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WebSocketKafkaVanilaJhKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebSocketKafkaVanilaJhKafkaResource(KafkaProperties kafkaProperties) {
